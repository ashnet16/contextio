...
class EnronClean():
    ...
    def __init__(self):
        ...
        self.dataStore = DataStore()
        self.dataStore.findAndUpdateContact('benjamin.rogers@enron.com_andrew.kelemen@enron.com')
        self.dataStore.findAndUpdateContact('benjamin.rogers@enron.com_missy.sturgeon@cinergy.com')
        self.dataStore.findAndUpdateContact('benjamin.rogers@enron.com_rosanna.migliaccio@robertwalters.com')
        self.dataStore.findAndUpdateContact('benjamin.rogers@enron.com_clukawski@hitt-gc.com')
        self.dataStore.findAndUpdateContact('benjamin.rogers@enron.com_dgioffre@hotmail.com')
        self.dataStore.findAndUpdateMessages('benjamin.rogers@enron.com','andrew.kelemen@enron.com' )
        self.dataStore.findAndUpdateMessages('andrew.kelemen@enron.com','benjamin.rogers@enron.com')
        self.dataStore.findAndUpdateMessages('benjamin.rogers@enron.com','missy.sturgeon@cinergy.com')
        self.dataStore.findAndUpdateMessages('missy.sturgeon@cinergy.com','benjamin.rogers@enron.com')
        self.dataStore.findAndUpdateMessages('benjamin.rogers@enron.com','rosanna.migliaccio@robertwalters.com')
        self.dataStore.findAndUpdateMessages('rosanna.migliaccio@robertwalters.com', 'benjamin.rogers@enron.com')
        self.dataStore.findAndUpdateMessages('benjamin.rogers@enron.com','clukawski@hitt-gc.com')
        self.dataStore.findAndUpdateMessages('clukawski@hitt-gc.com','benjamin.rogers@enron.com')
        self.dataStore.findAndUpdateMessages('benjamin.rogers@enron.com','dgioffre@hotmail.com')
        self.dataStore.findAndUpdateMessages('dgioffre@hotmail.com','benjamin.rogers@enron.com')
        self.dataStore.findAndUpdatePersonalities('benjamin.rogers@enron.com')
        self.dataStore.findAndUpdatePersonalities('andrew.kelemen@enron.com')
        self.dataStore.findAndUpdatePersonalities('missy.sturgeon@cinergy.com')
        self.dataStore.findAndUpdatePersonalities('rosanna.migliaccio@robertwalters.com')
        self.dataStore.findAndUpdatePersonalities('clukawski@hitt-gc.com')
        self.dataStore.findAndUpdatePersonalities('dgioffre@hotmail.com')
        self.dataStore.findAndUpdateUser('benjamin.rogers@enron.com')
...
if __name__ == "__main__":
    ...
    #EnronDB('jeffrey.shankman@enron.com', 'Jeffrey Shankman')  == DONE
    #EnronDB('chris.germany@enron.com', 'Chris Germany')
    #print ' -- START VINCE KAMINSKY --'
    #EnronDB('vince.kaminski@enron.com', 'Vince Kaminsky') == DONE
